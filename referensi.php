                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper blue-grey darken-1">
                                    <div class="col m7">
                                        <ul class="left">
                                            <li class="waves-effect waves-light hide-on-small-only"><a href="?page=ref" class="judul"><i class="material-icons">class</i> Klasifikasi SPPT</a></li>';
                ...
                $cari = mysqli_real_escape_string($config, $_REQUEST['cari']);
                    ...
                    <div class="col m12" id="colres">
                        <table class="bordered" id="tbl">
                            ...
                            $query = mysqli_query($config, "SELECT * FROM tbl_klasifikasi WHERE kode LIKE '%$cari%' ORDER BY id_klasifikasi DESC LIMIT 15");
