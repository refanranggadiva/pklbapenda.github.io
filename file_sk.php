                                        ...
                                        <div class="col m12 white">
                                            <table>
                                                <tbody>
                                                    ...
                                                    <tr>
                                                    <td width="13%">Nama WP</td>
                                                    <td width="1%">:</td>
                                                    <td width="86%">'.$row['nama_wp'].'</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td width="13%">NOP</td>
                                                        <td width="1%">:</td>
                                                        <td width="86%">'.$row['nop'].'</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="13%">Tanggal Pengambilan</td>
                                                        <td width="1%">:</td><td width="86%">'.indoDate($row['tgl_pengambilan']).'</td>
                                                    </tr>
                                                    <tr>
                                                ...
                                                <div class="col s9 left">
                                                    <div class="card">
                                                        <div class="card-content">
                                                            <p>File lampiran SPPT keluar ini bertipe <strong>document</strong>, silakan klik link dibawah ini untuk melihat file lampiran tersebut.</p>
                                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col s12">
                                                <div class="col s9 left">
                                                    <div class="card">
                                                        <div class="card-content">
                                                            <p>File lampiran SPPT keluar ini bertipe <strong>PDF</strong>, silakan klik link dibawah ini untuk melihat file lampiran tersebut.</p>
                                                        </div>
                                                        <div class="card-action">
                                                            <strong>Lihat file :</strong> <a class="blue-text" href="./upload/surat_keluar/'.$row['file'].'" target="_blank">'.$row['file'].'</a>
                                                        </div>
