...
<nav class="blue-grey darken-1">
    <div class="nav-wrapper">
        <a href="./" class="brand-logo center hide-on-large-only"><i class="material-icons md-36">mail</i> SPPT</a>
        <ul id="slide-out" class="side-nav" data-simplebar-direction="vertical">
                    ...
                    <?php
                        ...
                        while($data = mysqli_fetch_array($query)){
                            ...
                            if(!empty($data['nama'])){
                                ...
                                echo '<h5 class="smk-side">BAPENDAk</h5>';
                            }
                            if(!empty($data['alamat'])){
                                echo '<p class="description-side">'.$data['alamat'].'</p>';
                            } else {
                                echo '<p class="description-side">Jl. Letnan Jenderal S. Parman No.3, Soklat, Kec. Subang, Kabupaten Subang, Jawa Barat 41211</p>';
                            }
                        }
                    ?>
                </div>
            ...
            <li class="no-padding">
                ...
                <ul class="collapsible collapsible-accordion">
                    <li>
                        <a class="collapsible-header"><i class="material-icons">repeat</i> Transaksi SPPT</a>
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="?page=tsm">SPPT Masuk</a></li>
                                <li><a href="?page=tsk">SPPT Keluar</a></li>
                            </ul>
                        </div>
                   </li>
                </ul>
            ...
            <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                    <li>
                        ...
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="?page=gsm">SPPT Masuk</a></li>
                                <li><a href="?page=gsk">SPPT Keluar</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
                    ...
                    <li>
                        ...
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li><a href="?page=sett&sub=usr">Admin</a></li>
        ...
        <ul class="center hide-on-med-and-down" id="nv">
            ...
            <?php
                if($_SESSION['admin'] == 1 || $_SESSION['admin'] == 3){ ?>
            <li><a class="dropdown-button" href="#!" data-activates="transaksi">Transaksi SPPT <i class="material-icons md-18">arrow_drop_down</i></a></li>
