                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper blue-grey darken-1">
                                    <div class="col m7">
                                        <ul class="left">
                                            <li class="waves-effect waves-light hide-on-small-only"><a href="?page=tsk" class="judul"><i class="material-icons">drafts</i> SPPT Keluar</a></li>
                            ...
                            <table class="bordered" id="tbl">
                                <thead class="blue lighten-4" id="head">
                                    <tr>
                                        ...
                                        <th width="31%">Nama WP<br/> File</th>
                                        <th width="24%">Uraian</th>
                                        <th width="19%">NOP<br/>Tgl Pengambilan</th>
                                ...
                                $query = mysqli_query($config, "SELECT * FROM tbl_surat_keluar WHERE nop LIKE '%$cari%' ORDER by id_surat DESC LIMIT $curr, 15");
                                if(mysqli_num_rows($query) > 0){
                                    ...
                                    while($row = mysqli_fetch_array($query)){
                                      ...
                                      <tr>
                                        ...
                                        <td>'.substr($row['nama_wp'],0,200).'<br/><br/><strong>File :</strong>';
                                        ...
                                        <td>'.$row['uraian'].'</td><td>'.$row['nop'].'<br/><hr/>'.indoDate($row['tgl_pengambilan']).'</td>
                                        <td>';
                            ...
                            if(mysqli_num_rows($query) > 0){
                                ...
                                while($row = mysqli_fetch_array($query)){
                                  ...
                                  <tr>
                                    ...
                                    <td>'.$row['uraian'].'</td><td>'.$row['nop'].'<br/><hr/>'.indoDate($row['tgl_cetak']).'</td>
                                    <td>';
