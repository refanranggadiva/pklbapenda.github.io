                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper blue-grey darken-1">
                                    <div class="col m7">
                                        <ul class="left">
                                            <li class="waves-effect waves-light hide-on-small-only"><a href="?page=tsm" class="judul"><i class="material-icons">mail</i> SPPT Masuk</a></li>
                        ...
                        <table class="bordered" id="tbl">
                            <thead class="blue lighten-4" id="head">
                                <tr>
                                    ...
                                    <th width="30%">Nama WP<br/> File</th>
                                    <th width="24%">Uraian</th>
                                    <th width="18%">NOP<br/>Tgl Cetak</th>
                            ...
                            $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk WHERE nop LIKE '%$cari%' ORDER by id_surat DESC LIMIT 15");
                            if(mysqli_num_rows($query) > 0){
                                ...
                                while($row = mysqli_fetch_array($query)){
                                  ...
                                  <tr>
                                    ...
                                    <td>'.$row['uraian'].'</td>
                                    <td>'.$row['nop'].'<br/><hr/>'.indoDate($row['tgl_cetak']).'</td>
                                    <td>';
