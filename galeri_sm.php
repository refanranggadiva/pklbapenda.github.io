                    ...
                    if(isset($_REQUEST['submit'])){
                        ...
                        echo '<!-- Row form Start -->
                            ...
                            <div class="row agenda">
                                <div class="col s12"> <p class="warna agenda">Galeri file SPPT masuk antara tanggal <strong>'.indoDate($dari_tanggal).'</strong> sampai dengan tanggal <strong>'.indoDate($sampai_tanggal).'</strong></p>
                                </div>
                            </div>';
                                ...
                                echo '<div class="col m12">
                                        <div class="card blue lighten-5">
                                            <div class="card-content notif">
                                                <span class="card-title lampiran"><center>Tidak ada file lampiran SPPT masuk yang ditemukan</center></span>
                                            </div>
                                        </div>
                                    </div>';
                            } echo '
